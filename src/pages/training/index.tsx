    ...
    <div className="max-w-2xl mx-auto p-4">
      ...
      {output && (
        <div className="mt-4">
          ...
          <pre className="bg-gray-100 p-3 rounded-md mt-2">{output}</pre>
        </div>
      )}
      {error && (
        <div className="mt-4">
          <h3 className="text-lg font-semibold text-red-500">{t("Error:")}</h3>
          <pre className="bg-red-100 p-3 rounded-md mt-2">{error}</pre>
        </div>
      )}
    </div>
  );
